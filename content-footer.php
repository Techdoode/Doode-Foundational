 ...
 if( get_theme_mod( 'wpforge_footer_position' ) == '') { ?>
    ...
    <?php if ( has_nav_menu('secondary')  ) : // Only display menu in the footer if one is assigned ?>
        ...
        <div id="ftxt" class="site-info medium-12 large-12 columns cntr">
            ...
            <?php } else { ?>
                 <p><?php _e( 'Powered by', 'wp-forge' ); ?> <a href="<?php echo esc_url(__('http://techdoode.com/','wp-forge')); ?>" rel="follow" target="_blank" title="<?php _e( 'A Responsive WordPress Theme', 'wp-forge' ); ?>"><?php _e( 'Doode-Foundational', 'wp-forge' ); ?></a> &amp; <a href="<?php echo esc_url(__('http://wordpress.org/','wp-forge')); ?>" target="_blank" title="<?php _e( 'WordPress', 'wp-forge' ); ?>"><?php _e( 'WordPress', 'wp-forge' ); ?></a></p>
            <?php } // end if ?>
